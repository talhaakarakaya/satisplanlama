                                   ...
                                   <table style="width: 100%;">
                                   	<tr>
                                   		<td align="left">
											<p class="text-muted font-14 m-b-30">
											   <a href="index.php"> 
												 <button type="button" class="btn btn-warning waves-effect waves-light"> <i class="fa fa-arrow-right"></i> <span>Yapılacaklar</span> </button>
											   </a>

											   <a href="tum-isler.php"> 
												<button type="button" class="btn btn-dark waves-effect waves-light"> <span>Tüm Yapılacaklar</span> </button>
											   </a>
											</p>
                                  		</td>
                                   		...
                                   		<td align="right">
											<p class="font-14 m-b-30">
											   <a href="is-ekle.php"> 
												 <button type="button" class="btn btn-success waves-effect waves-light"> <span>İş Ekle</span> </button>
											   </a>
											</p>
                                  		</td>
                                   	</tr>
                                   	<tr>
                                   		<td colspan="2">
											  ...
											  <div class="alert alert-danger alert-dismissible fade show" role="alert">
														...
														Teslim edilmeyen veya ödemesi alınmayan iş sonlandırılamaz!
											   </div>
                            	    ...
                            	    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap dikey" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="https://wa.me/<?php echo $cari_tel; ?>?text=Merhaba,%20Reklam%20Noktası'ndan%20RN<?php echo $iscek['is_id']; ?>%20numaralı%20siparişiniz%20için%20ulaşıyorum.%20http://www.reklamnoktasi.com.tr" style="font-weight: bold; color: black" target="_blank"><?php echo $cari_tel_duzgun; ?></a></td>
