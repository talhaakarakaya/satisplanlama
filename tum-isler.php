                                   	...
                                   	<tr>
                                   		<td align="left">
											<p class="text-muted font-14 m-b-30">
											   <a href="index.php"> 
												 <button type="button" class="btn btn-dark waves-effect waves-light"> <span>Yapilacaklar</span> </button>
											   </a>

											   <a href="tum-isler.php"> 
												<button type="button" class="btn btn-warning waves-effect waves-light"> <i class="fa fa-arrow-right"></i> <span>Tüm Yapilacaklar</span> </button>
											   </a>
											</p>
                                  		</td>
                                  		<td align="right">
                                           ...
                                           <br> <a href="https://wa.me/<?php echo $cari_tel; ?>?text=Merhaba,%20Reklam%20Noktasi'ndan%20RN<?php echo $iscek['is_id']; ?>%20numarali%20siparisiniz%20için%20ulasiyorum.%20http://www.reklamnoktasi.com.tr" style="font-weight: bold; color: black" target="_blank"><?php echo $cari_tel_duzgun; ?></a></td>
                                            ...
                                            <td>
												...
												<!-- Teslim Edilmediyse -->
													...
													<button type="submit" name="teslim_edildi_yap_tum" class="btn btn-icon waves-effect waves-light btn-danger"> <i class="fa fa-remove"></i> </button>
													</form>
												<!-- Teslim Edilmediyse/ -->
												<?php				
													}else{
												...
												<!-- Teslim Edildiyse -->
													...
													<form action="islem.php" method="post">
													<input type="hidden" name="is_id" value="<?php echo $is_id; ?>">
													<button type="submit" name="teslim_edilmedi_yap_tum" class="btn btn-icon waves-effect waves-light btn-success"> <i class="fa fa-thumbs-o-up"></i> </button>
													</form>
                                            ...
                                            <td>
                                        		...
                                        		<a href="islem.php?is_id=<?php echo $iscek['is_id']; ?>&is_sil=oktum"><button type="button" class="btn btn-icon waves-effect waves-light btn-danger" style="height: 30px; width: 30px; padding: 0;">
